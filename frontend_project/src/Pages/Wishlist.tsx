  ...
  return (
    <main className="container" style={{ padding: "32px var(--space-4) 80px", minHeight: "60vh", color: 'var(--text-primary)' }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "24px", flexWrap: "wrap", gap: "12px" }}>
        <div>
          <h1 style={{ fontSize: "20px", fontWeight: "800", letterSpacing: "-0.3px", display: "flex", alignItems: "center", gap: "8px" }}>
            My Wishlist 
        ...
        {wishlistedProducts.length > 0 && (
          <button
            ...
            style={{ color: "#ef4444", fontSize: "12px", fontWeight: "700", border: "none", background: "none", cursor: "pointer", borderBottom: "1.5px solid #fca5a5", padding: "2px 0" }}
          >
            Clear All Items
          </button>
        )}
      ...
      {wishlistedProducts.length === 0 ? (
        ...
        >
          <HeartCrack size={42} style={{ color: "var(--text-muted)" }} />
          <h3 style={{ margin: 0, fontWeight: "800", fontSize: "16px" }}>Your Wishlist is Empty</h3>
          <p style={{ margin: 0, fontSize: "13px", color: "var(--text-secondary)", maxWidth: "340px", lineHeight: "1.5" }}>
            Bookmark your favorite items by tapping the heart icon on any card inside the catalog listings.
          </p>
          <Link to="/catalog">
            <button 

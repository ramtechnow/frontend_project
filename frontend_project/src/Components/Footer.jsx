...
import { Mail, ShieldAlert, CreditCard, Award, ExternalLink } from "lucide-react";
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand-column">
            ...
            <p className="footer-brand-description">
              A premium, responsive React e-commerce portfolio project demonstrating clean state transitions, Firebase integration, and a mobile-first interface.
            </p>
            <div className="footer-social-list">
              ...
              <a href="mailto:contact@shopper-demo.com" className="footer-social-btn" aria-label="Email Customer Support">
                <Mail size={18} />
              </a>
            </div>
          </div>
          ...
          <div className="footer-contact-column">
            ...
            <div className="footer-contact-item">
              <Award size={18} />
              <span>
                Built with React, React Router, Context API, and CSS Custom Properties.
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom-bar">
          <span className="footer-copyright">
            &copy; {new Date().getFullYear()} SHOPPER Portfolio Project. All rights reserved. Developed by Antigravity.
          </span>
          <div className="footer-payment-logos" aria-label="Accepted simulated payment options">
            <CreditCard size={20} title="Credit Cards" />
